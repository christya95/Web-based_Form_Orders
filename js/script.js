...
function formSubmit() {
    ...
    return true; // skip all JS validations. Returns from here and the rest of the code does not work. To add JS validations, comment this line
    ...
    */
    ...
    if (errors.trim() != '') { // trim is the function that trims any empty spaces from front or back
        ...
        return false; // if there are errors, stop the form from being submitted
    } else {
        return true; // if there are no errors, allow the form to be submitted
    }
